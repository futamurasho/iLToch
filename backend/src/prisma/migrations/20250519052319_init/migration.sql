/*
  ...
  - Added the required column `emailAdress` to the `friends` table without a default value. This is not possible if the table is not empty.
...
CREATE UNIQUE INDEX "friends_userId_emailAdress_key" ON "friends"("userId", "emailAdress");
